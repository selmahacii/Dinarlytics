    ...
    <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-2xl p-6 shadow-xl border border-slate-700 mb-8 relative overflow-hidden group">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-white font-bold text-lg uppercase tracking-wider">{t('dashboard.reviewer_guide.title')}</h3>
        </div>

        <p className="text-slate-300 mb-6 max-w-2xl text-lg">
          {t('dashboard.reviewer_guide.intro', { name: 'Dinarlytics' })}
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <span className="block text-white font-bold">{t('dashboard.reviewer_guide.commercial_title')}</span>
                <span className="text-slate-400 text-xs">{t('dashboard.reviewer_guide.commercial_subtitle')}</span>
              </div>
            </div>
            <div className="flex items-center gap-2 bg-emerald-500/20 px-2 py-1 rounded text-[10px] font-bold text-emerald-400 animate-bounce">
              {t('dashboard.reviewer_guide.commercial_cta')}
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <span className="block text-white font-bold">{t('dashboard.reviewer_guide.audit_title')}</span>
                <span className="text-slate-400 text-xs">{t('dashboard.reviewer_guide.audit_subtitle')}</span>
              </div>
            </div>
            <div className="flex items-center gap-2 bg-blue-500/20 px-2 py-1 rounded text-[10px] font-bold text-blue-400">
              {t('dashboard.reviewer_guide.audit_cta')}
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <span className="block text-white font-bold">{t('dashboard.reviewer_guide.reports_title')}</span>
                <span className="text-slate-400 text-xs">{t('dashboard.reviewer_guide.reports_subtitle')}</span>
              </div>
            </div>
