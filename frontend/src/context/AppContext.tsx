...
import { getFiscalRates, getTVARatePercent, calculateTVA, FiscalRates } from '../utils/fiscalRates';
import { getCountryFromDevise, getFiscalDocumentsByCountry, Country, FiscalDocument } from '../utils/fiscalDocuments';
...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const formatCurrency = (amount: number): string => {
    const symbols = { DZD: 'DA', EUR: '€', USD: '$' } as const;
