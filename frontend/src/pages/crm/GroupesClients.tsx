...
import { mockGroupesClients, mockClientsParGroupe, getAllClientsFromGroupes } from '../../data/mockGroupesClients.ts';
...
const GroupesClients: React.FC = () => {
  ...
  // Utilisation des données mock centralisées
  const groupesClients = mockGroupesClients;
  ...
  // Récupération des clients par groupe
  const allClients = getAllClientsFromGroupes(groupesClients);
              ...
              {groupesClients.map((groupe: GroupeClient) => (
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-sm font-medium border ${
                    getCouleurClasses(groupe.couleur)
                  }`}
                >
                      ...
                      <tr key={client.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            client.risque === 'faible' ? 'bg-green-100 text-green-800' :
